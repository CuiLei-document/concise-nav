...
var beautifyUrl = function beautifyUrl(url) {
...
var render = function render() {
  ...
  hashMap.forEach(function (node, index) {
    var $li = $("\n             <li>\n                     <div class=\"site\">\n                         <div class=\"logo\">".concat(node.logo, "</div>\n                         <div class=\"link\">").concat(beautifyUrl(node.url), "\n                         </div>\n                         <div class=\"close\">\n                            X\n                        </div>\n                    </div>\n             </li>\n             ")).insertBefore($last);
    $li.click(function () {
...
$('.addButton').click(function () {
  ...
  hashMap.push({
    logo: beautifyUrl(url)[0].toUpperCase(),
    url: url
  });
  render();
});
...
//# sourceMappingURL=main.3f19de0d.js.map